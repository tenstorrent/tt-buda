...
TEST(TestDramReadEstimatorInternal, compute_dram_pipe_scatter_chunk_size_tiles)
{
    ...
    scatter_chunk_size = compute_dram_pipe_scatter_chunk_size_tiles(
        120 /* scatter_gather_num_tiles */, 10 * 2080 /* unpacker_buffer_size_bytes */, 2080 /* tile_size */);
    EXPECT_EQ(scatter_chunk_size, 10);

    scatter_chunk_size = compute_dram_pipe_scatter_chunk_size_tiles(
        1200 /* scatter_gather_num_tiles */, 100 * 2080 /* unpacker_buffer_size_bytes */, 2080 /* tile_size */
    );
    EXPECT_EQ(scatter_chunk_size, 25);

    scatter_chunk_size = compute_dram_pipe_scatter_chunk_size_tiles(
        2 /* scatter_gather_num_tiles */, 10 * 2080 /* unpacker_buffer_size_bytes */, 2080 /* tile_size */
    );
