...
from pybuda.transformers.pipeline import pipeline as NLPPipelineWrapper
...
def test_mistral(variant, test_device):
    ...
    # test should work for batch size 1 and seqlen <= 128q
...
def test_mistral_decode(variant, test_device):
    ...
    print(f'{test_device.arch} {test_device.devtype}')
