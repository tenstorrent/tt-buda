...
class BudaElementWiseBinaryTest(PyBudaModule):
    """
        ...
        In this test we have 22 operators with three input operands and three trainable operands.
    ...
    def forward(self, x1, x2, x3):
        ...
        op9 = self.operator(self.opname + "9", self.train_param2, x3)
        ...
        op16 = self.operator(self.opname + "16", op9, self.train_param3)

        # Layer 7
        op17 = self.operator(self.opname + "17", op14, op15)
        op18 = self.operator(self.opname + "18", op15, op16)
